...
function addDetailPage() {
    var liObj = $('<li class="paginate_button" aria-controls="DataTables_Table_0" tabindex="0"><span>...</span></li>') ;
    $(".page_show_btn").append(liObj) ;
}
function previousPage() {   // 上一页按钮
    var liObj = $('<li class="paginate_button previous" aria-controls="DataTables_Table_0" tabindex="0" id="DataTables_Table_0_previous"></li>');    // 定义li元素
    var aObj = $('<a>上一页</a></li>');
...
function nextPage() {   // 下一页按钮
    var liObj = $('<li class="paginate_button next" aria-controls="DataTables_Table_0" tabindex="0" id="DataTables_Table_0_next"></li>');    // 定义li元素
...
function clearBar() {   // 清空已有的内容
    $(".page_show_btn li").remove();
}
function addBar(index) { // 专门生成分页控制代码
    var liObj = $('<li class="paginate_button" aria-controls="DataTables_Table_0" tabindex="0"></li>');    // 定义li元素
